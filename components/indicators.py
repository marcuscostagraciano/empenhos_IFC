...
def indicators():
    ...
    with row[0]:
        st.markdown(
            f"<p style='font-size: 2.4em; font-weight: 700;'>R$ {committed}</p>",
    ...
    with row[1]:
        st.markdown(
            f"<p style='font-size: 2.4em; font-weight: 700;'>R$ {settled}</p>",
            unsafe_allow_html=True,
        )
    ...
    with row[2]:
        st.markdown(
            f"<p style='font-size: 2.4em; font-weight: 700; color: red;'>R$ {balance}</p>",
            unsafe_allow_html=True,
        )
